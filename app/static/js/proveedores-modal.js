...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const nuevoProveedorModal = new bootstrap.Modal(modalElement);
      // Agregar evento para manejar el foco cuando se cierra el modal
    modalElement.addEventListener('hide.bs.modal', function (event) {
        // Transferir el foco fuera del modal antes de que se cierre
        setTimeout(() => {
            btnNuevoProveedor.focus();
        }, 0);
    });
    
    // También capturar el clic en el botón de cierre para manejar el foco correctamente
    ...
    nuevoProveedorForm.addEventListener('submit', function(e) {
        ...
        .then(data => {
            ...
            // Si la creación fue exitosa, agregar la nueva opción al select
                ...
                // Transferimos el foco antes de cerrar el modal
                setTimeout(() => {
                    btnNuevoProveedor.focus();
                    // Cerrar el modal después de transferir el foco
